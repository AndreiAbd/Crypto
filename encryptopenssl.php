    ...
    <body>
        <div class="container">
            ...
            <form method="POST" name="FORM" action=""> 
                <button 
                    class="btn btn-outline-dark mb-4 mt-4"
                    name="MAIN" 
                    type="submit"
                >
                الصفحة الرئيسية
                ...
                <p 
                    id="main-article"
                >
                <i class="fas fa-keyboard"></i> : Data - البيانات
                </p>
                <input
                    style="
                    ...
                    "
                    class="form-control" 
                    placeholder="put any text you want" 
                    type="text" 
                    name="DATA"
                />
                <p 
                    id="main-article"
                >
                <i class="fas fa-keyboard"></i> : Key - مفتاح حماية التشفير
                </p>
                <input 
                    style="
                        border: 1px solid black;
                    ...
                    " 
                    class="form-control" 
                    placeholder="if you need KEY lock" 
                    type="number" 
                    name="KEY"
                />
                <p 
                ...
                <p 
                    id="main-article"
                >
                <i class="fas fa-keyboard"></i> : Option - الخيارات المتاحة إفتراضياً تأخذ القيمة صفر
                </p>
                <input 
                    style="
                        border: 1px solid black;
            ...
            if (isset($_POST['FORM'])) {
                ...
                $option = $_POST['OPTION'];
                $vi= $_POST['VI'];
                $encryptedData = openssl_encrypt($data, $method, $key, $option, $vi);
            }else{
                echo '';
            }
